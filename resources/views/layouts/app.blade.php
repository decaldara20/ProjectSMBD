...
<head>
    ...
    <style>
        ...
        .nav-link-active { color: #00FFFF !important; font-weight: 700; text-shadow: 0 0 10px rgba(0, 255, 255, 0.4); }
        ...
        <div class="relative w-full flex flex-col group/design-root min-h-screen">
            <div class="layout-container flex h-full grow flex-col">
                ...
                @unless(request()->routeIs('login') || request()->routeIs('register'))
                    <header class="sticky top-0 z-50 flex items-center justify-center whitespace-nowrap bg-white/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-solid border-gray-200 dark:border-neon-cyan/20 px-4 sm:px-8 md:px-10 lg:px-20 py-3 transition-all duration-300">
                        <div class="flex w-full max-w-[1400px] items-center justify-between gap-4">
                            
                            <div class="flex items-center gap-8 shrink-0">
                                
                                <a href="/" class="flex items-center gap-3 text-gray-900 dark:text-white no-underline group">
                                    <img src="{{ asset('images/logo.png') }}" 
                                        alt="IMTVDB Logo" 
                                        class="w-10 h-10 object-contain group-hover:scale-110 transition-transform duration-300 drop-shadow-[0_0_5px_rgba(0,255,255,0.5)]">
                                    
                                    <h2 class="text-3xl font-bold leading-tight tracking-[-0.015em] text-cyan-600 dark:text-neon-cyan transition-all duration-300" style="text-shadow: 0 0 10px rgba(6, 182, 212, 0.2);">
                                        IMTVDB
                                    </h2>
                                </a>
                                ...
                                <nav class="hidden xl:flex items-center gap-6">
                                    ...
                                    class="{{ request()->routeIs('films.index') ? 'text-cyan-600 dark:text-neon-cyan font-bold drop-shadow-[0_0_8px_rgba(0,255,255,0.4)]' : 'text-gray-600 dark:text-[#EAEAEA]' }} hover:text-cyan-600 dark:hover:text-neon-cyan transition-colors duration-300 text-sm font-medium">
                                    Films
                                    </a>

                                    <a href="{{ route('tv.index') }}" 
                                    class="{{ request()->routeIs('tv.index') ? 'text-cyan-600 dark:text-neon-cyan font-bold drop-shadow-[0_0_8px_rgba(0,255,255,0.4)]' : 'text-gray-600 dark:text-[#EAEAEA]' }} hover:text-cyan-600 dark:hover:text-neon-cyan transition-colors duration-300 text-sm font-medium">
                                    TV Shows
                                    </a>
                                    
                                    <div class="relative group">
                                        <button class="flex items-center gap-1 {{ request()->routeIs('artists.*') || request()->routeIs('person.*') ? 'text-cyan-600 dark:text-neon-cyan font-bold drop-shadow-[0_0_8px_rgba(0,255,255,0.4)]' : 'text-gray-600 dark:text-[#EAEAEA]' }} hover:text-cyan-600 dark:hover:text-neon-cyan transition-colors duration-300 text-sm font-medium focus:outline-none py-2">
                                            People <i class="fas fa-chevron-down text-[10px] ml-1 transition-transform group-hover:rotate-180"></i>
                                        </button>
                                        <div class="absolute left-0 top-full mt-0 w-48 bg-white dark:bg-[#1A1A1A] border border-gray-200 dark:border-white/10 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 overflow-hidden p-2">
                                            <a href="{{ route('artists.index', ['profession' => 'actor']) }}" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-600 dark:text-gray-300 hover:bg-cyan-50 dark:hover:bg-white/5 hover:text-cyan-600 dark:hover:text-neon-cyan rounded-lg"><i class="fas fa-user-tie w-4"></i> Actors</a>
                                            <a href="{{ route('artists.index', ['profession' => 'director']) }}" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-600 dark:text-gray-300 hover:bg-cyan-50 dark:hover:bg-white/5 hover:text-cyan-600 dark:hover:text-neon-cyan rounded-lg"><i class="fas fa-video w-4"></i> Directors</a>
                                            <a href="{{ route('artists.index', ['profession' => 'writer']) }}" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-600 dark:text-gray-300 hover:bg-cyan-50 dark:hover:bg-white/5 hover:text-cyan-600 dark:hover:text-neon-cyan rounded-lg"><i class="fas fa-pen-nib w-4"></i> Writers</a>
                                            <div class="h-px bg-gray-200 dark:bg-white/10 my-1"></div>
                                            <a href="{{ route('artists.index') }}" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-600 dark:text-gray-300 hover:bg-cyan-50 dark:hover:bg-white/5 hover:text-cyan-600 dark:hover:text-neon-cyan rounded-lg"><i class="fas fa-users w-4"></i> All Artists</a>
                                        </div>
                                    </div>

                                    <div class="relative group">
                                        <button class="flex items-center gap-1 {{ request()->has('genre') ? 'text-cyan-600 dark:text-neon-cyan font-bold drop-shadow-[0_0_8px_rgba(0,255,255,0.4)]' : 'text-gray-600 dark:text-[#EAEAEA]' }} hover:text-cyan-600 dark:hover:text-neon-cyan transition-colors duration-300 text-sm font-medium focus:outline-none py-2">
                                            Genres <i class="fas fa-chevron-down text-[10px] ml-1 transition-transform group-hover:rotate-180"></i>
                                        </button>
                                        <div class="absolute left-0 top-full mt-0 w-[600px] bg-white dark:bg-[#1A1A1A] border border-gray-200 dark:border-white/10 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 overflow-hidden p-6">
                                            <div class="grid grid-cols-3 gap-x-4 gap-y-2">
                                                @if(isset($globalGenres))
                                                    @foreach($globalGenres as $genre)
                                                        <a href="/search?genre={{ $genre->genre_name }}" class="block px-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:bg-cyan-50 dark:hover:bg-white/5 hover:text-cyan-600 dark:hover:text-neon-cyan rounded-lg truncate transition-colors">
                                                            {{ $genre->genre_name }}
                                                        </a>
                                                    @endforeach
                                                @endif
                            ...
                            <div class="hidden lg:flex flex-1 justify-center px-4">
                                <form action="/search" method="GET" class="relative group w-full flex justify-center">
                                    <div class="relative w-full max-w-[400px] group-focus-within:max-w-[600px] transition-all duration-500 ease-in-out">
                                        <div class="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none z-10">
                                            <svg class="w-5 h-5 text-gray-500 dark:text-gray-400 group-focus-within:text-cyan-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                                        </div>
                                        <input type="text" name="q" id="globalSearch" class="block w-full pl-12 pr-12 py-2.5 bg-gray-100 dark:bg-[#1A1A1A]/80 border border-gray-300 dark:border-gray-700 rounded-full text-sm text-gray-900 dark:text-gray-200 placeholder-gray-500 focus:outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/50 focus:bg-white dark:focus:bg-black transition-all duration-300 shadow-sm dark:shadow-lg" placeholder="Search films, TV shows, or artists..." autocomplete="off">
                                        <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none"><span class="text-xs text-gray-500 border border-gray-300 dark:border-gray-700 rounded px-2 py-0.5 font-mono group-focus-within:text-cyan-500 group-focus-within:border-cyan-500/50">/</span></div>
                                    </div>
                                </form>
                            </div>

                            <div class="flex items-center gap-3 shrink-0">
                                <button onclick="toggleFilterPanel()" class="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 dark:bg-[#1A1A1A] hover:bg-cyan-100 dark:hover:bg-neon-cyan/20 text-gray-600 dark:text-white transition-all duration-300 group border border-transparent hover:border-cyan-200 dark:hover:border-neon-cyan/30" title="Advanced Filter">
                                    <span class="material-symbols-outlined group-hover:text-cyan-600 dark:group-hover:text-neon-cyan text-[20px]">tune</span>
                                </button>

                                <button id="theme-toggle" class="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 dark:bg-[#1A1A1A] hover:bg-cyan-100 dark:hover:bg-neon-cyan/20 text-gray-600 dark:text-white transition-all duration-300 group border border-transparent hover:border-cyan-200 dark:hover:border-neon-cyan/30" title="Ganti Tema">
                                    <span class="material-symbols-outlined group-hover:text-cyan-600 dark:group-hover:text-neon-cyan text-[20px]" id="theme-icon">dark_mode</span>
                                </button>

                                <a href="{{ route('history.index') }}" class="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 dark:bg-[#1A1A1A] hover:bg-cyan-100 dark:hover:bg-neon-cyan/20 text-gray-600 dark:text-white transition-all duration-300 group border border-transparent hover:border-cyan-200 dark:hover:border-neon-cyan/30 {{ request()->routeIs('history.index') ? 'border-cyan-500 dark:border-neon-cyan text-cyan-600 dark:text-neon-cyan shadow-[0_0_10px_rgba(0,255,255,0.3)]' : '' }}" title="Riwayat">
                                    <span class="material-symbols-outlined group-hover:text-cyan-600 dark:group-hover:text-neon-cyan text-[20px]">history</span>
                                </a>

                                <a href="{{ route('favorites.index') }}" class="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 dark:bg-[#1A1A1A] hover:bg-cyan-100 dark:hover:bg-neon-cyan/20 text-gray-600 dark:text-white transition-all duration-300 group border border-transparent hover:border-cyan-200 dark:hover:border-neon-cyan/30 {{ request()->routeIs('favorites.index') ? 'border-cyan-500 dark:border-neon-cyan text-cyan-600 dark:text-neon-cyan shadow-[0_0_10px_rgba(0,255,255,0.3)]' : '' }}" title="Favorit Saya">
                                    <span class="material-symbols-outlined group-hover:text-cyan-600 dark:group-hover:text-neon-cyan text-[20px]">favorite</span>
                                </a>
                                ...
                                @auth
                                    <div class="relative group">
                                        <button class="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 dark:bg-[#1A1A1A] border-2 border-transparent group-hover:border-cyan-500 dark:group-hover:border-neon-cyan transition-all duration-300 overflow-hidden shadow-md">
                                            <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=random&color=fff&size=128" alt="{{ Auth::user()->name }}" class="w-full h-full object-cover">
                                        </button>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="flex gap-3">
                            <div class="relative w-1/3">
                                <select name="profession" class="w-full bg-gray-50 dark:bg-[#0a0a0a] border border-gray-300 dark:border-white/20 rounded-xl text-xs text-gray-900 dark:text-white p-3 appearance-none cursor-pointer focus:ring-pink-500 focus:border-pink-500">
                            ...
                            <div class="relative w-2/3">
                                ...
                                <input type="text" name="q" placeholder="Search Name..." class="w-full bg-gray-50 dark:bg-[#0a0a0a] border border-gray-300 dark:border-white/20 rounded-xl text-sm text-gray-900 dark:text-white p-3 pl-9 focus:ring-pink-500 focus:border-pink-500 transition-all">
                                
                                </div>
                        </div>
                        <p class="text-[10px] text-gray-500">
                            *Select specific role or leave "All" to search everyone (Cinematographer, Composer, etc).
                        </p>
                    </div>
                </form>
            </div>
