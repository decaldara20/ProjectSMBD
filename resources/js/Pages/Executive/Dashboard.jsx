...
// --- 1. COMPONENT: KPI CARD (PREMIUM STYLE) ---
...
// --- 2. COMPONENT: INSIGHT ROW (BI WIDGET) ---
const InsightRow = ({ term, count, trend }) => (
...
export default function Dashboard({ stats, charts, topMovies, bi, filters }) {
    ...
    const commonOptions = {
        ...
        scales: { 
            x: { display: false }, 
            y: { display: false } // Hide grid lines for cleaner look
        },
        layout: { padding: 10 }
    };
        ...
        <DashboardLayout>
            ...
            <div className="space-y-8 pb-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {/* 3B. BUSINESS INTELLIGENCE: CONTENT GAPS */}
                    <div className="bg-[#121212] p-6 rounded-2xl border border-white/5 shadow-lg flex flex-col">
                        <div className="flex justify-between items-start mb-4">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-1">
                                    Items searched by users but <span className="text-red-400 font-bold">not found</span>.
                                </p>
                            </div>
                        ...
                        <button className="mt-auto w-full py-3 rounded-xl bg-linear-to-r from-red-600/20 to-red-600/10 border border-red-500/20 text-red-400 font-bold text-xs uppercase tracking-widest hover:bg-red-600/20 transition-all flex items-center justify-center gap-2">
